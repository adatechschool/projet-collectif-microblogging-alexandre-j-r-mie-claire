<x-app-layout>
    ...
    <div class="flex-row mt-4"> 
        <h1 class="mb-4 text-xl text-center font-bold text-gray-700">Categories</h1>
    <div class="  flex items-center px-8 mt-10">
        <div class="flex-row flex max-w-sm px-4 py-6 mx-auto bg-white rounded-lg shadow-md">
