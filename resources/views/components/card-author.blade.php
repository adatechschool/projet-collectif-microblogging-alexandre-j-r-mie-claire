...
@foreach ($users as $user)
    @if ($user->id != auth()->user()->id)
         <li class="flex items-center">
            <img src="{{ $user->avatar ? asset('storage/images/'.$user->avatar) : asset('storage/images/avatar-default.jpeg') }}" alt="avatar" class="object-cover w-10 h-10 mx-4 rounded-full">
