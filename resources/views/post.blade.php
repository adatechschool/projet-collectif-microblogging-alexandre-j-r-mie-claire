                ...
                <div class="mt-6">
                    <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        <img
                                      ...
                                      alt="avatar" class="hidden object-cover w-32 h-32 mx-4  sm:block">
                        ...
                        <div class="flex items-center justify-between mt-4"><a href="#"
                                class="text-blue-500 hover:underline">Read more</a>
                                        <a href="#" class="flex items-center"><h1 class="font-bold text-gray-700 hover:underline">Alex John</h1></a>
